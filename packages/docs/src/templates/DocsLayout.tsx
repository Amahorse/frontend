...
import { CContainer } from '@coreui/react-pro/src/'
...
const DocsLayout: FC<DocsLayoutProps> = ({ children, data, pageContext }) => {
  ...
  const preview_component = pageContext.frontmatter ? pageContext.frontmatter.preview_component : ''
      ...
      <CContainer lg className="my-md-4 flex-grow-1">
        <main className="docs-main order-1">
          <div className="docs-intro ps-lg-4">
            ...
            <Banner preview={preview_component} />
            {name && name !== title ? (
