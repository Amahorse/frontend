...
const Header: FC = () => {
  ...
  return (
    <>
      <AppContext.Consumer>
        {(context) => (
          <CHeader className="mb-5 elevation-0 border-bottom" position="sticky">
            <CHeaderToggler
              className="ms-md-3"
              onClick={() => {
            ...
            <CButton
              ...
              variant="outline"
            >
              <CIcon className="me-lg-2" icon={cilCloudDownload} />
              <span className="d-none d-lg-inline-block">Download</span>
            </CButton>
            <CButton
              className="d-lg-inline-block my-2 my-md-0 ms-md-3"
              color="primary"
