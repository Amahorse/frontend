...
| **itemsPerPageSelect** | Adds select element over table, which is used for control items per page in pagination. If you want to customize this element, pass object with optional values:<br/>- external (Boolean) - disables automatic 'itemsPerPage' change. | `boolean` \| `ItemsPerPageSelect` | - |
