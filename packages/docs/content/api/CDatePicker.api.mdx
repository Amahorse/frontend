...
| **inputOnChangeDelay** **_5.0.0+_** | Defines the delay (in milliseconds) for the input field's onChange event. | `number` | - |
...
| **selectionType** **_5.0.0+_** | Specify the type of date selection as day, week, month, or year. | `'day'` \| `'week'` \| `'month'` \| `'year'` | - |
