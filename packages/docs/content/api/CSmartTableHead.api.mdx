...
| --- | --- | --- | --- |
| **as** | - | `(ElementType & 'symbol')` \| `(ElementType & 'object')` \| `(ElementType & 'thead')` \| `(ElementType & 'slot')` \| `(ElementType & 'style')` \| `... 174 more ...` \| `(ElementType & FunctionComponent<...>)` | - |
...
| **handleSort** | - | `(key: string, index: number, order?: 'desc'` \| `'asc') => void` | - |
| **items** | - | `Item[]` | - |
