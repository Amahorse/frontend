...
| **hours** **_5.0.0+_** | Specify a list of available hours using an array, or customize the filtering of hours through a function. | `number[]` \| `((hour: number) => number[])` | - |
...
| **minutes** **_5.0.0+_** | Toggle the display of minutes, specify a list of available minutes using an array, or customize the filtering of minutes through a function. | `boolean` \| `number[]` \| `((minute: number) => number[])` | true |
...
| **seconds** **_4.8.0+_** | Toggle the display of seconds, specify a list of available seconds using an array, or customize the filtering of seconds through a function. | `boolean` \| `number[]` \| `((second: number) => number[])` | true |
