...
<CRow>
  <CCol md={6}>
    <CCard className="mb-4">
      <CCardBody>
        <CLink className="text-decoration-none text-reset" href="https://coreui.io/product/free-react-admin-template/" target="_blank">
  ...
  <CCol md={6}>
    <CCard className="mb-4">
      <CCardBody>
        <CLink className="text-decoration-none text-reset" href="https://coreui.io/product/next-js-dashboard-template/?theme=default-v3" target="_blank">
          <CCardTitle>Next.js Dashboard Template</CCardTitle>
  ...
  <CCol md={6}>
    <CCard className="mb-4">
      <CCardBody>
        <CLink className="text-decoration-none text-reset" href="https://coreui.io/product/next-js-dashboard-template/?theme=light-v3" target="_blank">
          <CCardTitle>Next.js Dashboard Template</CCardTitle>
  ...
  <CCol md={6}>
    <CCard className="mb-4">
      <CCardBody>
        <CLink className="text-decoration-none text-reset" href="https://coreui.io/product/next-js-dashboard-template/?theme=default" target="_blank">
          <CCardTitle>Next.js Dashboard Template</CCardTitle>
  ...
  <CCol md={6}>
    <CCard className="mb-4">
      <CCardBody>
        <CLink className="text-decoration-none text-reset" href="https://coreui.io/product/next-js-dashboard-template/?theme=light" target="_blank">
          <CCardTitle>Next.js Dashboard Template</CCardTitle>
  ...
  <CCol md={6}>
    <CCard className="mb-4">
      <CCardBody>
        <CLink className="text-decoration-none text-reset" href="https://coreui.io/product/next-js-dashboard-template/?theme=dark" target="_blank">
          <CCardTitle>Next.js Dashboard Template</CCardTitle>
