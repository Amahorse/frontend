...
const importNodes = {
  data: {
    estree: {
      body: [
        {
          source: {
            raw: "'@coreui/react-pro'",
            type: 'Literal',
            value: '@coreui/react-pro',
          },
          specifiers: [
            {
  ...
  type: 'mdxjsEsm',
  value: "import { CTab, CTabContent, CTabList, CTabPanel, CTabs } from '@coreui/react-pro';",
}
...
function plugin(options = {}) {
  ...
  return function transformer(tree) {
    ...
    visit(tree, ['code', 'mdxjsEsm'], (node, index, parent) => {
      if (is(node, 'mdxjsEsm') && node.value.includes('@coreui/react-pro')) {
